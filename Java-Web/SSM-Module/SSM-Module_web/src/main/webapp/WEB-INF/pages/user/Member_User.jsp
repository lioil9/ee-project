...
<div class="i_bg bg_color">
    ...
    <div class="m_content">
        <div class="m_left">
            ...
            <div class="left_m">
                ...
                <ul>
                    ...
                    <li><a href="user/getAddress">收货地址</a>
                    </li>
                    <li><a href="#">缺货登记</a></li>
                    <li><a href="#">跟踪订单</a></li>
                </ul>
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="<%=request.getContextPath()%>/user/Member_User.jsp" class="now">用户信息</a>
                    </li>
            ...
            <div class="left_m">
                ...
                <ul>
                    <li><a href="<%=request.getContextPath()%>/user/Member_Safe.jsp">账户安全</a></li>
        ...
        <div class="m_right">
            <div class="m_des">
                <table border="0" style="width:870px; line-height:22px;" cellspacing="0"
                       cellpadding="0">
                    <tr valign="top">
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;"
                   cellspacing="0" cellpadding="0">
                <tr>
            ...
            <table border="0" class="mon_tab" style="width:870px; margin-bottom:20px;"
                   cellspacing="0" cellpadding="0">
                <tr>
                    <td width="40%">用户ID：<span style="color:#555555;">${sessionScope.user.id}</span>
                    </td>
                    <td width="60%">用户姓名：<span
                            style="color:#555555;">${sessionScope.user.userName}</span></td>
                </tr>
                <tr>
                    <td>电&nbsp; &nbsp; 话：<span
                            style="color:#555555;">${sessionScope.user.mobile}</span></td>
                    <td>邮&nbsp; &nbsp; 箱：<span
                            style="color:#555555;">${sessionScope.user.email}</span></td>
                </tr>
                <tr>
                    <td>身份证号：<span style="color:#555555;">${sessionScope.user.identityCode}</span>
                    </td>
