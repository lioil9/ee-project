    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            <div class="list_t">
                ...
                <span class="fr">共发现${searchResult.size()}件</span>
            </div>
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    <c:if test="${!empty searchResult}">
                        <c:forEach var="product" items="${searchResult}">
                            <li>
                                <div class="img"><a href="getProductDetail?pid=${product.id}"><img
                                        src="images/per_8.jpg" width="210" height="185"/></a></div>
                                <div class="price">
                                    <font>￥<span><fmt:formatNumber value="${product.price}" type="currency" pattern=".00"/></span></font> &nbsp; 26R
                                </div>
                                <div class="name"><a href="#">${product.name}
                                </a></div>
                                <div class="carbg">
