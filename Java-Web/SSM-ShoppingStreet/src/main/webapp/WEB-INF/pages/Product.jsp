...
<div class="i_bg">
    ...
    <div class="content">
        ...
        <div class="pro_des">
            <div class="des_name"><p>${product.name}</p>${product.description}</div>
            <div class="des_price">本店价格：<b>￥${product.price}</b><br/>
                库存：<span>${product.stock}</span></div>
<%--            <%--%>
<%--                Product product = (Product)request.getAttribute("product");--%>
<%--                if (product != null){--%>
<%--                  out.print("<div class=\"des_name\"><p>");--%>
<%--                  out.print(product.getName());--%>
<%--                  out.print("</p>"+product.getDescription()+"</div>");--%>
<%--                  out.print(" <div class=\"des_price\">");--%>
<%--                  out.print("本店价格：<b>￥"+product.getPrice()+"</b><br/>");--%>
<%--                  out.print("库存：<span>"+product.getStock()+"</span></div>");--%>
<%--                }--%>
<%--            %>--%>
            ...
            <div class="des_join">
                ...
                <span class="fl">
                    <input id="addCart" style="display: <%=cartVisible%>" type="image" src="images/j_car.png"/>
                    <a onclick="ShowDiv_1('MyDiv2','fade2')" style="display: <%=isLogin%>"><img src="images/j_car.png" /></a>
<%--                    <a--%>
<%--                        id="addCart"--%>
<%--                        href="addCart.do?pid=<%=product.getId()%>"--%>
<%--                        onclick="addCart()"--%>
<%--                ><img src="images/j_car.png" /></a>--%>
                </span>
            </div>
            </form>
        </div>
    ...
    <!--Begin 弹出层-提醒登陆 Begin-->
    <div id="fade2" class="black_overlay"></div>
    <div id="MyDiv2" class="white_content">
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;" onclick="CloseDiv_1('MyDiv2','fade2')"><img src="images/close.gif" /></span>
            </div>
            <div class="notice_c">
                <table border="0" align="center" style="margin-top:;" cellspacing="0" cellpadding="0">
                    <tr valign="top">
                        <td>
                            <span style="color:#3e3e3e; font-size:18px; font-weight:bold;">请<a href="login" style="color: rgb(255,40,0)">登陆</a>后再将商品添加至购物车</span><br />
                        </td>
                    </tr>
                </table>
