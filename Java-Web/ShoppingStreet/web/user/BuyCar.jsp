...
<div class="top">
    <div class="logo"><a href="<%=request.getContextPath()%>/index.jsp"><img src="images/logo.png"/></a></div>
    <div class="search">
        <form>
        ...
        <table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0"
            ...
            <tr height="70">
                <td colspan="6" style="font-family:'Microsoft YaHei'; border-bottom:0;">
                    <label class="r_rad"><input type="checkbox" name="clear"
                                                checked="checked"/></label><label class="r_txt">清空购物车</label>
                    <span class="fr">商品总价：<b style="font-size:22px; color:#ff4e00;">￥<%=String
                            .format("%.0f", sum)%></b></span>
                </td>
            </tr>
        ...
        <div class="white_d">
            <div class="notice_t">
                <span class="fr" style="margin-top:10px; cursor:pointer;"
                      onclick="CloseDiv('MyDiv','fade')"><img src="images/close.gif"/></span>
            </div>
            <div class="notice_c">
