...
<div class="i_bg">
    ...
    <div class="content mar_20">
        ...
        <%
            List<Product> products = new ArrayList<>((List<Product>) request.getAttribute("searchResult"));
            String isVisible;
            if(products.isEmpty()){
              isVisible = "visible";
            }else {
        ...
        <div class="l_list">
            ...
            <div class="list_c">
                ...
                <ul class="cate_list">
                    ...
                    %>
                    <li>
                        <div class="img"><a href="detail.do?pid=<%=product.getId()%>"><img src="images/per_8.jpg" width="210" height="185" /></a></div>
                        <div class="price">
                            <font>￥<span><%=String.format("%.2f",product.getPrice())%></span></font> &nbsp; 26R
                        </div>
